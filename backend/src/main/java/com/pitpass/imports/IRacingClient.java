...
public class IRacingClient {
    ...
    public IRacingClient(
            @Value("${pit-pass.iracing.client-id:}") String clientId,
            @Value("${pit-pass.iracing.client-secret:}") String clientSecret,
            @Value("${pit-pass.iracing.username:}") String username,
            @Value("${pit-pass.iracing.password:}") String password,
            ...
            @Value("${pit-pass.iracing.token-url:https://oauth.iracing.com/oauth2/token}") String tokenUrl,
            @Value("${pit-pass.iracing.data-base:https://members-ng.iracing.com/data}") String dataBase) {
