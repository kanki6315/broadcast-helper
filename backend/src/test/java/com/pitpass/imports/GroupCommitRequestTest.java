...
class GroupCommitRequestTest {
    ...
    private static ImportTarget target(Long seriesId) {
        return new ImportTarget(seriesId, null, null, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    void chosenEventNamePrefersOverrideThenPayload() {
        assertEquals("Rolex 24", ImportService.chosenEventName(
                new ImportTarget(1L, null, null, "Rolex 24", null, null, null, null, null, null, null, null, null),
                "Daytona"));
        ...
        assertEquals("Daytona", ImportService.chosenEventName(
                new ImportTarget(1L, null, null, "  ", null, null, null, null, null, null, null, null, null),
                "Daytona"));
    }
