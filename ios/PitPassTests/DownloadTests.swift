...
struct DownloadPlanTests {
    ...
    @Test func downloadsIncludeSupportedCalculatorBaselinesOnly() throws {
        let hub: SeasonHub = try Fixtures.decode(Fixtures.hub.replacingOccurrences(of: "\"rowCount\":0", with: "\"rowCount\":12"))
